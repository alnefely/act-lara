...
<head>
    <meta charset="utf-8" />
    <title>إدارة التخطيط والتطوير - التعليم العام بالطائف</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-login__wrapper">
            <div class="m-login__container">
                ...
                <div class="m-login__signup">
                    <div class="m-login__head">
                        <h3 class="m-login__title">تسجيل مستخدم</h3>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-form__group">
                                    <select required class="form-control m-input m-input--air m-input--pill" id="acc-type" name="account_type">
                                        <option value="" selected disabled>الحساب لـ</option>
                                        <option value="1">ادارة - قسم</option>
                                        <option value="2">منسق ادارة</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6">
