...
class CreateInsertTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('education')->insert([
            [
                'name' => 'الادارة العامة للتعليم بمنطقة نجران',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمنطقة الباحة ',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمنطقة جازان',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة بمنطقة عسير ',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمنطقة حائل',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمنطقة تبوك ',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمنطقة القصيم ',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمنطقة الحدود الشمالية ',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمنطقة الجوف',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمحافظة الأحساء',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمنطقة المدينة المنورة ',
                'created_at' => now(),
            ],
            [
            ...
            [
                'name' => 'الادارة العامة للتعليم بمنطقة الشرقية ',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمحافظة جدة',
                'created_at' => now(),
            ],
            [
                'name' => 'الادارة العامة للتعليم بمنطقة الرياض ',
                'created_at' => now(),
            ],
        ]);
