      ...
      <div class="row">
        ...
        <div class="col-lg-8 mx-auto">
          <div class="bg-white rounded text-center p-5 shadow-down">
            <h5 class="mb-80">ادخل بريدك الالكتروني المسجل في الموقع</h5>
            <form class="row"  action="{{ url()->current() }}" method="post">@csrf
              <div class="col-md-6">
                <input type="text" id="email" name="email" placeholder="البريد الالكتروني" class="form-control px-0 mb-4  text-right" required>
              </div>
  
              <div class="col-lg-6 col-10 mx-auto">
                <button class="btn btn-primary w-100">استعادة</button>
              </div>
            </form>
            <br>
