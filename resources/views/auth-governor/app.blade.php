            ...
            <div class="main-sidemenu">
                <div class="app-sidebar__user clearfix">
                    <div class="dropdown user-pro-body">
                        <div class="">
                            <img  class="avatar avatar-xl brround" src="/dashboard/img/profile.png"><span class="avatar-status profile-status bg-green"></span>
                        </div>
                        <div class="user-info">
                            <h4 class="font-weight-semibold mt-3 mb-0">{{ auth('governor')->user()->name }}</h4>
                        </div>
                    </div>
                </div>
                <ul style="font-family: 'Cairo';" class="side-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="{{ url('/governor/home') }}">
                            <i class="fas fa-balance-scale side-menu__icon"></i>
                            <span class="side-menu__label">المشاركات المسندة</span>
                        </a>
                    </li>

                    <li class="slide">
                        <a class="side-menu__item" href="{{ url('/governor/profile') }}">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="{{ url('/governor/logout') }}">
